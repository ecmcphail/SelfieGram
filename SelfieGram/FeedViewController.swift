...
//        let post4 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Grumpy Cat 4")
        ...
        let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=4056ec51025d38067a5d42431282e82a&tags=dog")!
...
//            let me = User(username: "sam", profileImage: UIImage(named: "Grumpy-Cat")!)
//            let post = Post(imageURL: URL(string:"")!, user: me, comment: "My Selfie")
//
